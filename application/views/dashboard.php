...
<li class="sidebar-item text-center p-20 upgrade-btn"> 
    ...
    <div class="project-card">
        <h3>Project Title</h3>
        <img src="prosd.jpg" alt="Project Screenshot" style="width: 100%; max-width: 600px;">
        <p>Sistem Informasi Akademik Nilai Siswa SDN 4 Tengguli adalah sebuah platform berbasis web yang dirancang untuk mempermudah pengelolaan data akademik dan nilai siswa di SDN 4 Tengguli. Dibangun menggunakan framework CodeIgniter dan didukung oleh bahasa pemrograman PHP, HTML, CSS, serta JavaScript, sistem ini memungkinkan pengelolaan data siswa, mata pelajaran, nilai, dan laporan secara efisien dan terstruktur. Dengan antarmuka yang sederhana dan fungsionalitas yang lengkap, sistem ini membantu pihak sekolah dalam mengelola dan memonitor perkembangan akademik siswa dengan lebih mudah.</p>
        <a href="https://github.com/anonim-blip/sdn4" target="_blank">View on GitHub</a>
    </div>
</section>
